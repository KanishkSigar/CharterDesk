...
$html .= '<style>
  ...
  body{font-family:"Times New Roman",Times,serif;color:#111;font-size:12px;line-height:1.5;margin:0}
  .brandbar{border-bottom:3px solid #0b2440;padding-bottom:6px;margin-bottom:12px}
  .brandbar .bn{font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:bold;color:#0b6fa4;letter-spacing:1px}
  .brandbar .bs{font-family:Arial,Helvetica,sans-serif;font-size:10px;color:#555}
  h1{font-size:20px;text-align:center;margin:8px 0 2px;letter-spacing:1px}
  .meta{text-align:center;color:#555;font-size:11px;margin-bottom:14px;font-family:Arial,Helvetica,sans-serif}
  h2{font-size:13px;border-bottom:1px solid #ccc;padding-bottom:3px;margin:18px 0 8px;font-family:Arial,Helvetica,sans-serif;color:#0b2440}
  .clause{margin:10px 0}
  .clause h3{margin:4px 0;font-size:12px;color:#0b2440}
  .clause p{margin:3px 0;text-align:justify}
  table{width:100%;border-collapse:collapse;margin-top:6px;font-size:11px}
  th,td{border:1px solid #ccc;padding:6px 8px;text-align:left;vertical-align:top}
  thead th{background:#0b2440;color:#fff;font-family:Arial,Helvetica,sans-serif}
  tbody th{background:#f1f5f9;width:28%;font-family:Arial,Helvetica,sans-serif}
  .sigtable{margin-top:46px;border:0}
  .sigtable td{border:0;font-family:Arial,Helvetica,sans-serif;font-size:12px}
  .sigline{border-top:1px solid #000;padding-top:4px}
  .docfooter{margin-top:26px;border-top:1px solid #ccc;padding-top:6px;color:#777;font-size:10px;font-family:Arial,Helvetica,sans-serif;text-align:center}
</style>';
$html .= '</head><body>';
$html .= '<div class="brandbar"><span class="bn">CHARTERDESK</span> &nbsp; <span class="bs">Maritime fixture documentation</span></div>';
$html .= '<h1>CHARTER PARTY (FIXTURE)</h1>';
$html .= '<div class="meta">Thread: '.htmlspecialchars($uuid).' &nbsp;|&nbsp; Generated: '.date('Y-m-d H:i').'</div>';
...
$html .= '<table class="sigtable"><tr>'
       . '<td width="45%"><br/><br/><div class="sigline">Charterer — name, signature &amp; date</div></td>'
       . '<td width="10%"></td>'
       . '<td width="45%"><br/><br/><div class="sigline">Owner — name, signature &amp; date</div></td>'
       . '</tr></table>';

$html .= '<div class="docfooter">Generated by CharterDesk &middot; Built during an internship at Integrated Maritime Exchange (IME). This document is a negotiation aid, not a substitute for a formally executed charter party.</div>';
